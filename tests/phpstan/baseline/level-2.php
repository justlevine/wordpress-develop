...
$ignoreErrors[] = [
	'message' => '#^Access to an undefined property WP_Term\\:\\:\\$id\\.$#',
	'identifier' => 'property.notFound',
	'count' => 1,
	'path' => __DIR__ . '/../../../src/wp-admin/includes/ajax-actions.php',
];
$ignoreErrors[] = [
	'message' => '#^Access to an undefined property WP_Term\\:\\:\\$link\\.$#',
	'identifier' => 'property.notFound',
	'count' => 1,
	'path' => __DIR__ . '/../../../src/wp-admin/includes/ajax-actions.php',
];
...
$ignoreErrors[] = [
	'message' => '#^Function get_category_by_path\\(\\) should return array\\<int\\|string, mixed\\>\\|WP_Error\\|WP_Term\\|null but return statement is missing\\.$#',
