...
$ignoreErrors[] = [
	'message' => '#^Parameter \\#7 \\$src_w of function imagecopy expects int, float given\\.$#',
	'identifier' => 'argument.type',
	'count' => 1,
	'path' => __DIR__ . '/../../../src/wp-admin/includes/image-edit.php',
];
$ignoreErrors[] = [
	'message' => '#^Parameter \\#8 \\$src_h of function imagecopy expects int, float given\\.$#',
	'identifier' => 'argument.type',
	'count' => 1,
	'path' => __DIR__ . '/../../../src/wp-admin/includes/image-edit.php',
];
...
$ignoreErrors[] = [
	'message' => '#^Parameter \\#2 \\$arr2 of function array_intersect expects an array of values castable to string, array\\<WP_Term\\> given\\.$#',
	'identifier' => 'argument.type',
	'count' => 1,
...
$ignoreErrors[] = [
	'message' => '#^Parameter \\#2 \\$timestamp of function gmdate expects int, false given\\.$#',
	'identifier' => 'argument.type',
	'count' => 1,
	'path' => __DIR__ . '/../../../src/wp-includes/class-wp-date-query.php',
];
...
$ignoreErrors[] = [
	'message' => '#^Parameter \\#2 \\$callback of method WP_Image_Editor_GD\\:\\:make_image\\(\\) expects callable\\(\\)\\: mixed, \'imageavif\' given\\.$#',
	'identifier' => 'argument.type',
	'count' => 1,
...
$ignoreErrors[] = [
	'message' => '#^Parameter \\#4 \\$mon of function mktime expects int, \\(string\\|false\\) given\\.$#',
	'identifier' => 'argument.type',
	'count' => 1,
	'path' => __DIR__ . '/../../../src/wp-includes/functions.php',
];
$ignoreErrors[] = [
	'message' => '#^Parameter \\#5 \\$day of function mktime expects int, \\(string\\|false\\) given\\.$#',
	'identifier' => 'argument.type',
	'count' => 1,
	'path' => __DIR__ . '/../../../src/wp-includes/functions.php',
];
$ignoreErrors[] = [
	'message' => '#^Parameter \\#6 \\$year of function mktime expects int, \\(string\\|false\\) given\\.$#',
	'identifier' => 'argument.type',
	'count' => 1,
	'path' => __DIR__ . '/../../../src/wp-includes/functions.php',
];
...
$ignoreErrors[] = [
	'message' => '#^Parameter \\#1 \\$args of function wp_insert_attachment expects array\\|string, stdClass\\|WP_Error given\\.$#',
	'identifier' => 'argument.type',
	'count' => 1,
